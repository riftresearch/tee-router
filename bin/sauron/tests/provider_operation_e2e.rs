...
fn order_worker_runtime_args_from_router_args(args: &RouterServerArgs) -> OrderWorkerRuntimeArgs {
    OrderWorkerRuntimeArgs {
        ...
        proxy_profile_ipv4_us_west_1_url: args.proxy_profile_ipv4_us_west_1_url.clone(),
        proxy_profile_ipv4_us_west_1_dns_mode: args.proxy_profile_ipv4_us_west_1_dns_mode.clone(),
        proxy_profile_ipv6_us_west_1_url: args.proxy_profile_ipv6_us_west_1_url.clone(),
        proxy_profile_ipv6_us_west_1_dns_mode: args.proxy_profile_ipv6_us_west_1_dns_mode.clone(),
        proxy_profile_ipv4_eu_url: args.proxy_profile_ipv4_eu_url.clone(),
        proxy_profile_ipv4_eu_dns_mode: args.proxy_profile_ipv4_eu_dns_mode.clone(),
        master_key_path: args.master_key_path.clone(),
        ethereum_mainnet_rpc_url: args.ethereum_mainnet_rpc_url.clone(),
        ethereum_mainnet_rpc_proxy_profile: args.ethereum_mainnet_rpc_proxy_profile.clone(),
        ...
        hyperunit_proxy_profile: args.hyperunit_proxy_profile.clone(),
        hyperliquid_api_url: args.hyperliquid_api_url.clone(),
        hyperliquid_proxy_profile: args.hyperliquid_proxy_profile.clone(),
        velora_api_url: args.velora_api_url.clone(),
        velora_proxy_profile: args.velora_proxy_profile.clone(),
        kyberswap_api_url: args.kyberswap_api_url.clone(),
        kyberswap_proxy_profile: args.kyberswap_proxy_profile.clone(),
        ...
        coinbase_proxy_profile: args.coinbase_proxy_profile.clone(),
    }
}
...
fn live_router_args(
    ...
    RouterServerArgs {
        ...
        proxy_profile_ipv6_us_west_1_url: None,
        proxy_profile_ipv6_us_west_1_dns_mode: "local-ipv6-only".to_string(),
        proxy_profile_ipv4_eu_url: live.hyperunit_proxy_url.clone(),
        proxy_profile_ipv4_eu_dns_mode: "system-default".to_string(),
        master_key_path: write_router_master_key(config_dir)
            .to_string_lossy()
            .to_string(),
        ...
        hyperunit_proxy_profile: live
            .hyperunit_proxy_url
            .as_ref()
            .map(|_| "ipv4-eu".to_string()),
