...
set_shared_ref bitcoin-indexer-v3 BITCOIN_INDEXER_ESPLORA_URL ESPLORA_HTTP_SERVER_URL
...
set_shared_ref sauron-worker-v3 ESPLORA_HTTP_SERVER_URL ESPLORA_HTTP_SERVER_URL
