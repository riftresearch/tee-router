...
const KNOWN_ASSETS: KnownAsset[] = [
  ...
  known('evm:1', 'Ethereum', 'WBTC', '0x2260fac5e5542a773aa44fbcfedf7c193bc2c599', 8),
  known('evm:42161', 'Arbitrum', 'ETH', 'native', 18),
  ...
  known('evm:42161', 'Arbitrum', 'WBTC', '0x2f2a2543b76a4166549f7aab2e75bef0aefc5b0f', 8),
